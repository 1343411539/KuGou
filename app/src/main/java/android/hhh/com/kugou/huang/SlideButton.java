...
public class SlideButton extends View {
    ...
    //椭圆边框颜色
    private String StrokeLineColor = "#00bebfc1";
    //椭圆未被选中时填充的颜色
    private String StrokeSolidColor = "#bebfc1";
    //椭圆被选中时填充的颜色
    private String StrockeCheckedSolidColor = "#00a9ff";
    //圆形边框颜色
    ...
    private int smallstrokeCheckedSolidColor_int;
     ...
     * @param strokeCheckedSolidColor 圆角矩形被选中的颜色
    ...
    public void setSmallCircleModel(int strokeLineColor, int strokeSolidColor,int strokeCheckedSolidColor ,int circleCheckedColor, int circleNoCheckedColor) {
        ...
        smallstrokeCheckedSolidColor_int = strokeCheckedSolidColor;
    ...
    /**
     * 设置按钮状态，输入true表示选中状态，false表示未被选中
     *
     * @param checked
     */
    ...
    private void init(Context context) {
        ...
        smallstrokeCheckedSolidColor_int = Color.parseColor(StrockeCheckedSolidColor);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isBigCircle) {
            ...
            circleRadius = strokeCircleRadius - (PADDING-2) * 2;
        }
    ...
    private void drawRect(Canvas canvas) {
        ...
        if (isBigCircle && isChecked) {
            ...
            mPaint.setColor(smallstrokeCheckedSolidColor_int);
        }else {
...
//    ————————————————
//    版权声明：本文为CSDN博主「郭辉先森」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
//    原文链接：https://blog.csdn.net/sinat_26708935/article/details/80436598
}
